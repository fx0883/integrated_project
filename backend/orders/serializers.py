...
class OrderCreateSerializer(OrderSerializer):
    ...
    def validate(self, data):
        ...
        if 'total_amount' not in data or data.get('total_amount', 0) == 0:
            ...
            if unit_price == 0:
                raise serializers.ValidationError({'unit_price': _('单价不能为0')})
...
class OrderListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'service_type', 'service_type_display', 'language_direction', 'word_count',
            'start_date', 'due_date', 'delivery_date', 'total_amount', 'translator_fee',
            'payment_status', 'payment_status_display', 'created_at', 'profit', 'profit_rate'
        ]
        read_only_fields = ('created_at', 'profit', 'profit_rate')
...
class OrderDetailSerializer(OrderSerializer):
    ...
    def get_translator_detail(self, obj):
        """
        获取译员详细信息
        """
        ...
        return {
            'id': obj.translator.id,
            'username': obj.translator.username,
            'email': obj.translator.email,
            'phone': obj.translator.phone,
            'nick_name': obj.translator.nick_name
        }
